...
function locale_formatDayOfYear(d, p) {
  return src_locale_pad(1 + src_day.count(src_year(d), d), p, 3);
}
...
function locale_formatWeekNumberSunday(d, p) {
  return src_locale_pad(sunday.count(src_year(d) - 1, d), p, 2);
}
...
function locale_formatWeekNumberISO(d, p) {
  d = locale_dISO(d);
  return src_locale_pad(thursday.count(src_year(d), d) + (src_year(d).getDay() === 4), p, 2);
}
...
function locale_formatWeekNumberMonday(d, p) {
  return src_locale_pad(monday.count(src_year(d) - 1, d), p, 2);
}
...
function locale_formatZone(d) {
  var z = d.getTimezoneOffset();
  return (z > 0 ? "-" : (z *= -1, "+"))
      + src_locale_pad(z / 60 | 0, "0", 2)
      + src_locale_pad(z % 60, "0", 2);
}
...
function locale_formatUTCDayOfYear(d, p) {
  return src_locale_pad(1 + src_utcDay.count(src_utcYear(d), d), p, 3);
}
...
function locale_formatUTCWeekNumberSunday(d, p) {
  return src_locale_pad(utcSunday.count(src_utcYear(d) - 1, d), p, 2);
}
...
function locale_formatUTCWeekNumberISO(d, p) {
  d = locale_UTCdISO(d);
  return src_locale_pad(utcThursday.count(src_utcYear(d), d) + (src_utcYear(d).getUTCDay() === 4), p, 2);
}
...
function locale_formatUTCWeekNumberMonday(d, p) {
  return src_locale_pad(utcMonday.count(src_utcYear(d) - 1, d), p, 2);
}
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-time-format/src/index.js
...
var InternalStateModule = __webpack_require__(20);
var defineIterator = __webpack_require__(80);
...
var arrayMethodIsStrict = __webpack_require__(76);
...
var anObject = __webpack_require__(5);
var requireObjectCoercible = __webpack_require__(13);
var sameValue = __webpack_require__(175);
var regExpExec = __webpack_require__(91);
...
var $ = __webpack_require__(6);
var DESCRIPTORS = __webpack_require__(7);
var USE_NATIVE_URL = __webpack_require__(92);
var global = __webpack_require__(3);
var defineProperties = __webpack_require__(78);
var redefine = __webpack_require__(10);
...
var toASCII = __webpack_require__(182);
var setToStringTag = __webpack_require__(32);
var URLSearchParamsModule = __webpack_require__(183);
var InternalStateModule = __webpack_require__(20);
